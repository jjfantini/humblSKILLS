...
## [3.0.0](https://github.com/jjfantini/humblSKILLS/compare/v2.41.0...v3.0.0) (2026-07-30)
...
* **doctor:** humanize adapter match reasons and explain rw/ro badges ([d8986a0](https://github.com/jjfantini/humblSKILLS/commit/d8986a0c259dbcede49a1fc512a0754c04498fcc))
...
* **eval:** add indie-launch-copy-iteration scenario to use-smart-humanize-text ([2ceb128](https://github.com/jjfantini/humblSKILLS/commit/2ceb12874c2b76b8ac9f934d890424af0f20b6e2))
...
* **list:** surface available updates in list output ([7447b18](https://github.com/jjfantini/humblSKILLS/commit/7447b182739cba03ca3a115e6797c49b48703fbe))
...
* **skills:** add Motion, React Bits, and Beautiful UI to use-smart-animation ([#214](https://github.com/jjfantini/humblSKILLS/issues/214)) ([93ff95b](https://github.com/jjfantini/humblSKILLS/commit/93ff95b8b2a0772cb6b62ede8dbe3c23b08b01d1))
...
* **skillset:** add init to scaffold a skillset file ([2cb9e7d](https://github.com/jjfantini/humblSKILLS/commit/2cb9e7df933d0d30aa79411d75f8ecd4b332f10f))
...
* **skillset:** add sync --prune and a dashboard sync tile ([6c92424](https://github.com/jjfantini/humblSKILLS/commit/6c9242440303210f5bc0eb66866a18c029c8926d))
...
* **skillset:** export and sync shareable skill sets ([7411702](https://github.com/jjfantini/humblSKILLS/commit/741170246c8c49e36b8023809a8021cbdf9c5ce7))
...
* **skillset:** sync from file:// and http(s):// URLs ([0a91d2c](https://github.com/jjfantini/humblSKILLS/commit/0a91d2c098d6cfe963e3480cd4764bbed4369758))
* **skills:** re-sync smart-frontend-design mirror and standardize provenance ([#215](https://github.com/jjfantini/humblSKILLS/issues/215)) ([de14804](https://github.com/jjfantini/humblSKILLS/commit/de14804885c21ab1dc4164e19f500b1c87ec4b8f))
...
* **tui:** add ? help overlay to two-pane list model ([81c474e](https://github.com/jjfantini/humblSKILLS/commit/81c474ebbecb2bce3c336108e6e1648f74ac506b))
...
* **eval/claudecode:** drop removed --output-dir/--skill-dir flags, add --permission-mode ([af6d686](https://github.com/jjfantini/humblSKILLS/commit/af6d6860acaf29167a5f967a45559cc1956013a9))
...
* **install:** carry preserved user data across a skill rename ([#218](https://github.com/jjfantini/humblSKILLS/issues/218)) ([11ef1a3](https://github.com/jjfantini/humblSKILLS/commit/11ef1a366992c617a8053976abfccda983d3bb6a))
...
* **tui:** prevent footer overflow, add filter-mode hints and detail scroll indicator ([3abf578](https://github.com/jjfantini/humblSKILLS/commit/3abf578f1b9e03e7cc085afcc8a69d6da36e4c27))
