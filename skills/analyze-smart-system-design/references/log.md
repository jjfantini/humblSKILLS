...
[INGEST 2026-06-01] Scaffolded analyze-smart-system-design via scripts/scaffold.sh.
  - Directory layout created: references/{wiki,raw}/, brain meta files, templates
  - Awaiting first raw material and wiki concepts

[INGEST 2026-06-01] Migrated analyze-smart-system-design to smart-skill. Staged 60 raw pages, authored wiki concepts across delivery/concepts/patterns/tech/breakdown/examples, rewrote SKILL.md router.
