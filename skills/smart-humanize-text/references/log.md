...
[INGEST 2026-04-17] Scaffolded smart-humanize-text via scripts/scaffold.sh.
  - Directory layout created: references/{wiki,raw}/, brain meta files, templates
  - Awaiting first raw material and wiki concepts

[INGEST 2026-04-17] Migrated humanize-text (flat, 232-line SKILL.md) -> smart-humanize-text (CCCCC smart skill).
  ...
  - lint.sh copied from smart-skill/scripts/ into local scripts/
...
[LINT 2026-04-19] 27 wiki, 1 raw. Hard: 0, Soft: 0. Regenerated _index.md.
