...
humblskills eval run smart-humanize-text --scenario indie-launch-copy-iteration --open

# Run both scenarios (default when --scenario is omitted):
humblskills eval run smart-humanize-text --open

# Head-to-head subset:
humblskills eval run smart-humanize-text --config smart_skill,no_skill
```
