...
[INGEST 2026-07-29] Scaffolded better-interface via scripts/scaffold.sh.
  - Directory layout created: references/{wiki,raw}/, brain meta files, templates
  - Awaiting first raw material and wiki concepts

[INGEST 2026-07-29] Ported better-interface from jakubkrehel/skills.
...
[LINT 2026-07-29] 3 wiki, 1 raw. Hard: 0, Soft: 0. Regenerated _index.md.
