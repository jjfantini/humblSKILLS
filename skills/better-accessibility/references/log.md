...
[INGEST 2026-07-29] Scaffolded better-accessibility via scripts/scaffold.sh.
  - Directory layout created: references/{wiki,raw}/, brain meta files, templates
  - Awaiting first raw material and wiki concepts

[INGEST 2026-07-29] Ported better-accessibility from jakubkrehel/skills.
...
[LINT 2026-07-29] 6 wiki, 7 raw. Hard: 0, Soft: 1. Regenerated _index.md.
