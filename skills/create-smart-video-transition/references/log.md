...
[INGEST 2026-04-20] Scaffolded create-smart-video-transition manually.
  - Target path /Users/jjfantini/github/humblSKILLS/skills/create-smart-video-transition/ is outside scripts/scaffold.sh's supported --location flags (personal|project), so files were copied from skills/smart-skill/ by hand.
...
[QUERY 2026-04-21] Extracted Prompt A/B/C templates from wiki concepts into assets/templates/.
  ...
  - Matches the create-smart-scroll-animation pattern (templates in assets/, conceptual rules in wiki/)
