...
out of scope for `create-smart-scroll-animation` — do not port them.
...
Reference skill uses JPEG. `create-smart-scroll-animation` overrides this with
...
## Features dropped for `create-smart-scroll-animation`
