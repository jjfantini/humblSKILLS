...
[INGEST 2026-04-20] Scaffolded create-smart-scroll-animation via scripts/scaffold.sh.
...
[INGEST 2026-04-20] 0.1.0 initial release of create-smart-scroll-animation.
  ...
  - 4 scripts: lint.sh (verbatim from smart-skill), probe.sh, extract-frames.sh, to-webp.sh
